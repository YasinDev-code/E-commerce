      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <div className="flex flex-col gap-1">
            ...
            <select name="size" className="ring ring-gray-300 rounded-md px-2 py-1" onChange={e => handleProductType({ type: "size", value: e.target.value })}>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
              {product.colors.map(color => (
                <div
                  className={`cursor-pointer border-1 ${productTypes.color === color ? "border-gray-600" : "border-gray-200"} rounded-full p-[2px]`}
                  key={color}
